...
public class Driver 
{
	...
	public static void main(String[] args) {
		...
		List<Coffee> co = dao.findCoffee(1);
		for(Coffee c : co)
		{
			System.out.println(c);
		}
		
		List<Coffee> cof = dao.findCoffeeByOrigin("Malaysia");
		for(Coffee c : cof)
		{
			System.out.println(c);
		}
...
//	2. Write a JPQL to get all the Coffee details sorted by origin **[ Points: 0.25 ]**
